    ...
    public class RegisterData : xIMUdata
    {
        ...
        private static Qvals LookupQval(ushort address)
        {
            switch (address)
            {
                ...
                case ((ushort)RegisterAddresses.GyroBiasAt25degCX): return Qvals.GyroBiasAt25degC;
                case ((ushort)RegisterAddresses.GyroBiasAt25degCY): return Qvals.GyroBiasAt25degC;
                case ((ushort)RegisterAddresses.GyroBiasAt25degCZ): return Qvals.GyroBiasAt25degC;
                case ((ushort)RegisterAddresses.GyroBiasTempSensitivityX): return Qvals.GyroBiasTempSensitivity;
                case ((ushort)RegisterAddresses.GyroBiasTempSensitivityY): return Qvals.GyroBiasTempSensitivity;
                case ((ushort)RegisterAddresses.GyroBiasTempSensitivityZ): return Qvals.GyroBiasTempSensitivity;
                case ((ushort)RegisterAddresses.GyroSample1Temp): return Qvals.CalibratedTherm;
                case ((ushort)RegisterAddresses.GyroSample1BiasX): return Qvals.GyroSampledBias;
                case ((ushort)RegisterAddresses.GyroSample1BiasY): return Qvals.GyroSampledBias;
                case ((ushort)RegisterAddresses.GyroSample1BiasZ): return Qvals.GyroSampledBias;
                case ((ushort)RegisterAddresses.GyroSample2Temp): return Qvals.CalibratedTherm;
                case ((ushort)RegisterAddresses.GyroSample2BiasX): return Qvals.GyroSampledBias;
                case ((ushort)RegisterAddresses.GyroSample2BiasY): return Qvals.GyroSampledBias;
                case ((ushort)RegisterAddresses.GyroSample2BiasZ): return Qvals.GyroSampledBias;
