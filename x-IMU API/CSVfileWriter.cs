...
namespace xIMU_API
{
    ...
    public class CSVfileWriter
    {
        ...
        public CSVfileWriter(string fileBasePath)
        {
            ...
            CSVheadings[(int)FileIndexes.ErrorMessages] = "Packet Number,Error Message";
            CSVheadings[(int)FileIndexes.CommandConfirmations] = "Packet Number,Command Confirmation";
        ...
        {
            if (streamWriters[(int)FileIndexes.ErrorMessages] == null)
            {
                streamWriters[(int)FileIndexes.ErrorMessages] = new System.IO.StreamWriter(FileBasePath + "_" + FileIndexes.ErrorMessages.ToString() + ".csv", false);
                streamWriters[(int)FileIndexes.ErrorMessages].WriteLine(CSVheadings[(int)FileIndexes.ErrorMessages]);
            }
            streamWriters[(int)FileIndexes.ErrorMessages].WriteLine(Convert.ToString(packetNumber) + "," + errorData.GetMessage());
            packetNumber++;
        }
        ...
        {
            if (streamWriters[(int)FileIndexes.CommandConfirmations] == null)
            {
                streamWriters[(int)FileIndexes.CommandConfirmations] = new System.IO.StreamWriter(FileBasePath + "_" + FileIndexes.CommandConfirmations.ToString() + ".csv", false);
                streamWriters[(int)FileIndexes.CommandConfirmations].WriteLine(CSVheadings[(int)FileIndexes.CommandConfirmations]);
            }
            streamWriters[(int)FileIndexes.CommandConfirmations].WriteLine(Convert.ToString(packetNumber) + "," + commandData.GetMessage());
            packetNumber++;
        }
